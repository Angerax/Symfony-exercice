...
class AdvertController extends Controller
{
    ...
    public function indexAction($page,Request $request)
    {
        ...
        $testSpam = "sjqhfbqskjdgbsqngkjhqb,gds,jhdbgdlfzkjdsn kdlk jhqerlkd hgqldkjf hgqlkdj hlqkdj hglqkjh lqkjdhg lqjdgc lsjfbglqejgfdhsq,bgsh,jgb";
        if($this->get('oc_platform.antispam')->isSpam($testSpam,true)){
//            throw new \Exception('This is SPAM');
        }
        
        
//        $adverts = $this->get('doctrine.orm.entity_manager')->getRepository('OCPlatformBundle:Advert')->getAdvertWithCategories(['Java','PHP']);
//        $applications = $this->get('doctrine.orm.entity_manager')->getRepository('OCPlatformBundle:Application')->getApplicationsWithAdvert(2);
        
//        dump($adverts[0]->getImage()->getUrl());
//        dump($adverts[0]);
//        die();
